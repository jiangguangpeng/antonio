Pod::Spec.new do |s|
  ...
  s.license          = 'MIT'              #开源协议
  s.author           = { "antonio" => "antonio.jiangguangpeng@gmail.com" }                   #作者信息
  ...
  s.source_files = 'PersonRepoDemo/PersonRepoDemo/*.{h,m}'     #代码源文件地址，**/*表示Classes目录及其子目录下所有文件，如果有多个目录下则用逗号分开，如果需要在项目中分组显示，这里也要做相应的设置
  #s.resource_bundles = {
  #  'JGPSpecRepo' => ['Assets/*.png']
  #}                                       #资源文件地址

  s.public_header_files = 'PersonRepoDemo/PersonRepoDemo/*.h'   #公开头文件地址
